...
extern int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "A S T O R I A   C O R E ");
    TC_LOG_INFO("server.worldserver", "http://TrinityCore.org / https://www.playastoria.cc/");
	TC_LOG_INFO("server.worldserver", "AstoriaCore Branch 0.4.1 - 07.08.2020 - 20:37 CEST");
