...
namespace LuaPlayer
{
	...
	int GetCustomSpellAmount(Eluna* /*E*/, lua_State* L, Player* player) //Fractional
	{
		Eluna::Push(L, player->GetCustomSpellAmount());
		return 1;
	}

	int UpdateCustomSpellAmount(Eluna* /*E*/, lua_State* L, Player* player) //Fractional
	{
		player->UpdateCustomSpellAmount();
		return 0;
	}

	//Should not be needed, since we modify customspellamount onspelllearn/unlearn.
	int ModifyCustomSpellAmount(Eluna* /*E*/, lua_State* L, Player* player) //Fractional
	{
		int modifier = Eluna::CHECKVAL<int>(L, 2);
		player->ModifyCustomSpellAmount(modifier);
		return 0;
	}

	int GetStatPoints(Eluna* /*E*/, lua_State* L, Player* player) //Fractional
	{
	...
	int UpdateStatPoints(Eluna* /*E*/, lua_State* L, Player* player) //Fractional
	{
		player->UpdateStatPoints();
		return 0;
	}

	int ModifyStatPoints(Eluna* /*E*/, lua_State* L, Player* player) //Fractional
	{
	...
	int SaveStatPoints(Eluna* /*E*/, lua_State* L, Player* player) //Fractional
	{
