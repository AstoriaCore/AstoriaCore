...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
		...
		int GetCustomSpellAmount(); //Fractional
		int FetchCustomSpellAmount(); //Fractional
		void UpdateCustomSpellAmount(); //Fractional
		void ModifyCustomSpellAmount(int mod); //Fractional
        ...
        void SetSkill(uint16 id, uint16 step, uint16 newVal, uint16 maxVal, bool npc = false);
        ...
        void LearnSkillRewardedSpells(uint32 skillId, uint32 skillValue, bool npc = false);
    ...
    private:
		...
		int m_customSpellAmount; //Fractional
