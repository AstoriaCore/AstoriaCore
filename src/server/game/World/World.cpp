...
void World::LoadConfigSettings(bool reload)
{
    ...
    rate_values[RATE_XP_GAIN_GATHER] = sConfigMgr->GetFloatDefault("Rate.XP.Gain.Gather", 1.0f);
	...
	// Custom XP Rates
	m_int_configs[CONFIG_CUSTOM_XP_LEVEL] = sConfigMgr->GetIntDefault("CustomXp.Level", 80);
	// End of Custom XP Rates
...
void World::SetInitialWorldSettings()
{
    ...
    TC_LOG_INFO("server.loading", "Loading level zones...");
    sObjectMgr->LoadZoneLevels();
...
void World::ResetDailyQuests()
{
    ...
    CharacterDatabase.Execute(stmt);
	//AstoriaHonorSystem reset
	CharacterDatabase.PExecute("UPDATE character_honor SET kills_yesterday=kills_today, kills_today=0, honor_yesterday=honor_today, honor_today=0");
...
void World::ResetWeeklyQuests()
{
	...
	//AstoriaHonorSystem reset
	CharacterDatabase.PExecute("UPDATE character_honor SET kills_last_week=kills_this_week, kills_this_week=0, honor_last_week=honor_this_week, honor_this_week=0");
