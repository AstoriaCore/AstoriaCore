...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    // Custom Racial
    CHAR_INS_INDIVIDUAL_RACIAL,
    CHAR_DEL_INDIVIDUAL_RACIAL,
    CHAR_SEL_INDIVIDUAL_RACIAL,
    CHAR_UPD_INDIVIDUAL_RACIAL,
    CHAR_ORC_INDIVIDUAL_RACIAL,
    CHAR_ORC_SEL_INDIVIDUAL_RACIAL,
